                  ...
                  <div class="col-lg-12 mb-5">
                    <div class="single-blog-item">
                      ...
                      <div class="blog-item-content mt-5">
                        ...
                        <p>بالإضافة لما سبق يطلب الطبيب إجراء الاختبارات والفحوصات البدنية لاستبعاد المشاكل الصحية التي قد تكون سببًا لظهور الأعراض، أو لاستبعاد الحالات الطبية ذات الأعراض المشابهة، وقد يطلب الطبيب طلب الخضوع للتصوير بالرنين المغناطيسي والتصوير المقطعي.</p>
                        <h3 id="التعامل">
                            التعامل مع مرض الفصام 
                        </h3>
                        <p> توجد مجموعة من النصائح التي يجدر بالمصابين بالفصام اتباعها، ومنها ما يأتي:
                            <ul>
